...
public class UpdateFeesDetails extends JFrame {
    ...
    public String updateData(){
        ...
        String rollNo = txt_rolllno.getText();
        ...
        try {
            Connection con = ConnectionProvider.getcon();
            PreparedStatement pst = con.prepareStatement("update fee_details set student_name =?, roll_no =?,payment_mode =?,cheque_no =?,bank_name =?,dd_no =?,courses =?,total_amount =?, date =?, amount =?, discount =?, subtotal =?, vat =?,total_in_words =?,remark =?,year1 =?,year2 =? where receipt_no =?");
            ...
            pst.setFloat(11, disAmount);
            pst.setFloat(12, subTotal);
            pst.setFloat(13, vatAmount);
    ...
    public void setRecords(){
        try {
            ...
            txt_rolllno.setText(rs.getString("roll_no"));
    ...
    private void initComponents() {
        ...
        txt_rolllno = new javax.swing.JTextField();
        ...
        txt_rolllno.setFont(new java.awt.Font("Tw Cen MT", 0, 12)); // NOI18N
        panelChild.add(txt_rolllno, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 110, 50, -1));
    ...
    private javax.swing.JTextField txt_rolllno;
